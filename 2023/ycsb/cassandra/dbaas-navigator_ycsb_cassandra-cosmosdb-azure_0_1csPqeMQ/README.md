...
The following data sets contain the raw performance data and metadata of the [benchANT DBaaS Navigator](https://benchant.com/navigator/dbaas) for the CRUD general purpose workload created by the [Yahoo Cloud Serving Benchmark (YCSB)](https://github.com/brianfrankcooper/YCSB). 


Each folder contains the data of a single run benchmark, i.e. one data point of the DBaaS Navigator performance data. 
